...
public interface ErrorConstants
{
   ...
   public static final AscError[] errorConstantsNB = { 
           ...
           new AscError(kError_Parser_keywordInsteadOfTypeExpr, "Syntaksfeil: %s som en ugyldig type." ),
   ...
   public static final AscError[] errorConstantsRU = { 
           ...
           new AscError(kError_Parser_keywordInsteadOfTypeExpr, "Синтаксическая ошибка: %s представляет недопустимый тип." ),
